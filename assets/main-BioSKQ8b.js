import{j as t,r as d,R as k,T as V,P as T,a as C,b as X}from"./style-ByZXMC8I.js";import{A as Q,D}from"./DiceFace-B_8eLFWB.js";import{I as N}from"./BugIcon-BTtisUsi.js";import{I as R}from"./FoldsIcon-BbpDl8C0.js";import{I as K}from"./ProductilesIcon-BiTc2F2G.js";import{I as P}from"./SumTilesIcon-Cy6uHP7a.js";import{I as ee}from"./FactorfallIcon-DoN6jpCB.js";import{I as te}from"./CluelessIcon-C2C3ZRzX.js";function se({size:e=56}){const n=e;return t.jsxs("svg",{width:n,height:n,viewBox:"0 0 64 64",fill:"none",xmlns:"http://www.w3.org/2000/svg","aria-hidden":!0,children:[t.jsx("rect",{x:"6",y:"6",width:"52",height:"52",rx:"10",stroke:"currentColor",strokeWidth:"4"}),t.jsx("path",{d:"M26 22v24",stroke:"currentColor",strokeWidth:"6",strokeLinecap:"round"}),t.jsx("path",{d:"M20 28l6-6",stroke:"currentColor",strokeWidth:"6",strokeLinecap:"round"}),t.jsx("path",{d:"M44 22c-6 0-10 6-10 12s4 12 10 12 10-6 10-12-4-12-10-12Z",stroke:"currentColor",strokeWidth:"6"})]})}const w="/puzzles/";function x(e){try{return localStorage.getItem(e)}catch{return null}}function ne(){const e=new Date,n=new Date(e.getTime()-480*60*1e3);return`${n.getUTCFullYear()}-${String(n.getUTCMonth()+1).padStart(2,"0")}-${String(n.getUTCDate()).padStart(2,"0")}`}function M(e){const n=new Date;n.setDate(n.getDate()-e);const r=new Date(n.getTime()-480*60*1e3);return`${r.getUTCFullYear()}-${String(r.getUTCMonth()+1).padStart(2,"0")}-${String(r.getUTCDate()).padStart(2,"0")}`}function B(e,n){return[0,1,2].map(r=>["1","2"].includes(x(`${e}:${n}:${r}`)))}function re(e,n){return[0,1,2].map(r=>x(`${e}:${n}:${r}`)==="2")}function oe(e,n){return[0,1,2].map(r=>{const o=x(`${e}:${n}:${r}:moves`);return o!=null?parseInt(o,10):null})}function S(e,n){if(e!=="clueless")return null;const r=x(`clueless:${n}:bestAttempts`);if(r==null)return null;const o=parseInt(r,10);return o>=1&&o<=99?o:null}function ie(e,n){return e!=="clueless"?!1:x(`clueless:${n}:failed`)==="1"}function F(e,n){return e==="clueless"?S(e,n)!=null:["1","2"].includes(x(`${e}:${n}`))}function le(e,n){return e==="clueless"?S(e,n)===1:x(`${e}:${n}`)==="2"}const ae=["easy","medium","hard"];function ce(e,n){const r=x(`clueless:${e}:${n}:bestAttempts`);if(r!=null){const o=parseInt(r,10);if(o>=1&&o<=99)return o}if(n==="medium"){const o=S("clueless",e);if(o!=null)return o}return null}function O(e){return ae.map(n=>ce(e,n))}function de(e){const n=e.split("-").map(Number);if(n.length!==3||n.some(Number.isNaN))return"";const[r,o,i]=n,l=Date.UTC(r,o-1,i,12,0,0),a=new Date(l).toLocaleString("en-US",{timeZone:"America/Los_Angeles"}).split(",")[0]?.trim()??"";return a?`${a}-targets`:""}function H(e){const n=de(e);if(!n)return 0;try{const r=x(n);if(!r)return 0;const o=JSON.parse(r);return Array.isArray(o)?o.filter(i=>i!=null&&i.solution!=null).length:0}catch{return 0}}function pe(e,n,r){const o=new URL(n,window.location.origin).href;return`${e.toUpperCase()}
${r}/10 targets
Play at ${o}`}const ue=365;function A(e,n,r){return e==="allten"?H(r)>0:e==="clueless"?O(r).some(o=>o!=null):n?F(e,r):B(e,r).some(Boolean)}function he(e,n=!1){const o=A(e,n,M(0))?0:1;let i=0;for(let l=o;l<=ue;l++){const a=M(l);if(A(e,n,a))i++;else break}return i}const W=new Set(["sumtiles","productiles"]),me=["Easy","Med","Hard"];function fe({gameKey:e,completions:n,perfects:r,moveCounts:o}){const i=W.has(e),l=n??[!1,!1,!1],a=r??[!1,!1,!1],m=o??[null,null,null];return t.jsx("div",{style:{display:"flex",gap:"6px",marginTop:"8px"},children:[0,1,2].map(p=>{const h=l[p],v=a[p],b=m[p]!=null?m[p]:null,g=h?i?b!=null?String(Math.min(b,99)):"✓":v?"★":"✓":t.jsx(D,{count:p+1,size:20});return t.jsx("div",{style:{width:"28px",height:"28px",borderRadius:"6px",background:h?"#22c55e":C,color:h?"#fff":T,fontWeight:900,fontSize:"1rem",display:"flex",alignItems:"center",justifyContent:"center",transition:"background 0.2s"},children:g},p)})})}function xe({completed:e,perfect:n,attempts:r,failed:o}){const i=r!=null||o,l=i?r!=null:e,a=i&&r!=null,m=i&&o&&r==null,p=a?"#22c55e":m?"#374151":l?"#22c55e":C,h=i?r!=null?r===1?"★":String(Math.min(r,99)):o?"•":"1":e?n?"★":"✓":"1";return t.jsx("div",{style:{display:"flex",gap:"6px",marginTop:"8px"},children:t.jsx("div",{style:{width:"28px",height:"28px",borderRadius:"6px",background:p,color:a||m||l?"#fff":T,fontWeight:900,fontSize:"1.06rem",display:"flex",alignItems:"center",justifyContent:"center",transition:"background 0.2s"},children:h})})}function ge({attempts:e}){return t.jsx("div",{style:{display:"flex",gap:"6px",marginTop:"8px"},children:[0,1,2].map(n=>{const r=e?.[n]??null,o=r!=null,i=o?r===1?"★":String(Math.min(r,99)):t.jsx(D,{count:n+1,size:20});return t.jsx("div",{style:{width:"28px",height:"28px",borderRadius:"6px",background:o?"#22c55e":C,color:o?"#fff":T,fontWeight:900,fontSize:"1rem",display:"flex",alignItems:"center",justifyContent:"center",transition:"background 0.2s"},children:i},n)})})}function be(e,n,r,o,i,l){const a=new URL(r,window.location.origin).href,m=W.has(e);let p=n.toUpperCase()+`
`;for(let h=0;h<3;h++){const v=me[h];if(o[h]){const b=m&&l&&l[h]!=null?` (${l[h]} moves)`:"",g=!m&&i&&i[h]?" (⭐ First try!)":"";p+=`${v}   🟩${b}${g}
`}else p+=`${v}   ⬜
...
`}else l+=`${i[a]}   ⬜
`}return l+="Play at "+o,l}function ve({size:e=18}){return t.jsxs("svg",{width:e,height:e,viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round","aria-hidden":!0,children:[t.jsx("circle",{cx:"6",cy:"12",r:"2.5"}),t.jsx("circle",{cx:"18",cy:"8",r:"2.5"}),t.jsx("circle",{cx:"18",cy:"16",r:"2.5"}),t.jsx("path",{d:"M8.5 11.5L15.5 9.2M8.5 12.5L15.5 14.8"})]})}const f=[{key:"allten",href:`${w}puzzlegames/allten/`,Icon:se,title:"All Ten",desc:"Use the given numbers to make each target from 1 to 10."},{key:"scurry",href:`${w}puzzlegames/scurry/`,Icon:N,title:"Scurry",desc:"Place bugs to fill every highlighted square."},{key:"clueless",href:`${w}puzzlegames/clueless/`,Icon:te,title:"Clueless",desc:"Fill in the missing letters to complete six crossing words.",single:!1},{key:"folds",href:`${w}puzzlegames/folds/`,Icon:R,title:"Folds",desc:"Reflect triangles to match the target pattern."},{key:"factorfall",href:`${w}puzzlegames/factorfall/`,Icon:ee,title:"Factorfall",desc:"Drop factors into the grid. Clear same-color groups that multiply to the target."},{key:"sumtiles",href:`${w}puzzlegames/sumtiles/`,Icon:P,title:"Sum Tiles",desc:"Slide tiles so every row and column hits its sum."},{key:"productiles",href:`${w}puzzlegames/productiles/`,Icon:K,title:"Productiles",desc:"Slide tiles so every row and column hits its product."}],je=new Date().toLocaleDateString("en-US",{weekday:"long",month:"long",day:"numeric"}),Se=2e3;function ze(){const e=d.useMemo(()=>ne(),[]),n=d.useMemo(()=>Object.fromEntries(f.filter(s=>!s.single&&s.key!=="clueless"&&s.key!=="allten").map(s=>[s.key,B(s.key,e)])),[e]),r=d.useMemo(()=>Object.fromEntries(f.filter(s=>!s.single&&s.key!=="clueless"&&s.key!=="allten").map(s=>[s.key,re(s.key,e)])),[e]),o=d.useMemo(()=>Object.fromEntries(f.filter(s=>!s.single&&s.key!=="clueless"&&s.key!=="allten").map(s=>[s.key,oe(s.key,e)])),[e]),i=d.useMemo(()=>O(e),[e]),l=d.useMemo(()=>Object.fromEntries(f.filter(s=>s.single).map(s=>[s.key,F(s.key,e)])),[e]),a=d.useMemo(()=>Object.fromEntries(f.filter(s=>s.single).map(s=>[s.key,le(s.key,e)])),[e]),m=d.useMemo(()=>Object.fromEntries(f.filter(s=>s.single).map(s=>[s.key,S(s.key,e)])),[e]),p=d.useMemo(()=>Object.fromEntries(f.filter(s=>s.single).map(s=>[s.key,ie(s.key,e)])),[e]),[h,v]=d.useState(0),b=d.useMemo(()=>Object.fromEntries(f.map(s=>[s.key,he(s.key,!!s.single)])),[e,h]),g=d.useMemo(()=>H(e),[e,h]),[_,$]=d.useState(null),[Z,I]=d.useState(!1),[G,E]=d.useState(!1),j=d.useRef(null);k.useEffect(()=>()=>{j.current&&clearTimeout(j.current)},[]),k.useEffect(()=>{const s=()=>v(y=>y+1),c=()=>{document.visibilityState==="visible"&&s()},u=y=>{y.persisted&&s()};return document.addEventListener("visibilitychange",c),window.addEventListener("pageshow",u),window.addEventListener("storage",s),()=>{document.removeEventListener("visibilitychange",c),window.removeEventListener("pageshow",u),window.removeEventListener("storage",s)}},[]);const Y=d.useCallback((s,c)=>{s.preventDefault(),s.stopPropagation();const u=f.find(z=>z.key===c);if(!u)return;const y=c==="allten"?pe(u.title,u.href,g):c==="clueless"?we(u.title,u.href,i):u.single?ye(u.title,u.href,l[c],a[c]):be(c,u.title,u.href,n[c],r[c],o[c]);navigator.clipboard.writeText(y).then(()=>{j.current&&clearTimeout(j.current),$(c),j.current=setTimeout(()=>{$(null),j.current=null},Se)})},[g,i,n,r,o,l,a]),q=d.useCallback((s,c)=>s==="allten"?g>0:s==="clueless"?i.some(u=>u!=null):c?l[s]:n[s]?.some(Boolean),[g,i,n,l]);return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
