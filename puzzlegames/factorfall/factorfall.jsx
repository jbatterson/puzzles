...
function loadCompletions(dateKey) {
    return [0, 1, 2].map(i => localStorage.getItem(`factorfall:${dateKey}:${i}`) === '1')
}
function markComplete(dateKey, idx) {
    localStorage.setItem(`factorfall:${dateKey}:${idx}`, '1')
}
                ...
                <div id="instructions-overlay">
                    <div className="modal-content" style={{ position: 'relative' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                            ...
                            <button className="btn-secondary" onClick={() => { setMode('tutorial'); setTutorialIdx(0); setShowInstructions(false) }}>
                                Tutorial Puzzles
                            </button>
                        </div>
                    </div>
