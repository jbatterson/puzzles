/*! For license information please see 961.760ba055.iframe.bundle.js.LICENSE.txt */
		...
		"./node_modules/@storybook/addon-essentials/node_modules/@storybook/addon-docs/dist/esm/blocks/index.js":
			(__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
				...
				var storyBlockIdFromId = function storyBlockIdFromId(storyId) {
					...
					getStoryProps = function getStoryProps(
						...
						var _docs$inlineStories = docs.inlineStories,
							...
							storyIsInline =
								"boolean" == typeof inline ? inline : inlineStories;
				...
				var Story = function Story(props) {
					...
					if (storyProps.inline) {
						...
						Promise.all([storyFnRan, rendered]).then(function () {
							channel.emit(
								core_events_dist_esm.default.STORY_RENDERED,
								storyId
							);
						});
					}
				...
				var extractComponentArgTypes = function extractComponentArgTypes(
						...
						return (argTypes = (0, filterArgTypes.h)(
							argTypes,
							include,
							exclude
						));
																...
																setAdditionalActionItems(
																	...
																	globalWindow.setTimeout(function () {
																		return setAdditionalActionItems(
																			additionalActionItems.filter(function (
																				item
																			) {
																				return "Copied" !== item.title;
																			})
								...
								var states = stories
									.map(function (story) {
										...
										return null ===
											...
											null ===
												(_story$parameters$doc2 =
													_story$parameters$doc.source) ||
				...
				var getNotes = function getNotes(notes) {
					...
					getInfo = function getInfo(info) {
						return (
							info &&
							("string" == typeof info ? info : (0, docgen.Bd)(info.text))
						);
					},
				...
				var mdx_document = window_default().document,
					...
					CodeOrSourceMdx = function CodeOrSourceMdx(_ref) {
						var className = _ref.className,
							children = _ref.children,
							rest = mdx_objectWithoutProperties(_ref, [
								"className",
								"children",
							]);
						if (
				...
				var DocsStory_templateObject,
					...
					HeaderWithOcticonAnchor = function HeaderWithOcticonAnchor(_ref3) {
						var as = _ref3.as,
							id = _ref3.id,
							children = _ref3.children,
							rest = mdx_objectWithoutProperties(_ref3, [
								"as",
								"id",
								"children",
							]),
				...
				var DocsContainer_document = window_default().document,
					...
					DocsContainer = function DocsContainer(_ref) {
						var context = _ref.context,
							children = _ref.children,
							storyId = context.id,
							_storyById$parameters = (0, context.storyById)(
								storyId
							).parameters,
					...
					Preview_Preview = browser_default()(
						...
						(0, ts_dedent_esm.C)(
							Preview_templateObject ||
								(Preview_templateObject =
									(function Preview_taggedTemplateLiteral(strings, raw) {
										return (
											raw || (raw = strings.slice(0)),
											Object.freeze(
												Object.defineProperties(strings, {
				...
				function W(e) {
					...
					if (r.length > 1 || q.forceWrapper) c = r;
						...
						if (1 === r.length)
							return (
								(c = r[0]),
								"string" == typeof c ? V("span", {key: "outer"}, c) : c
							);
						c = null;
					}
				...
				!0 !== q.disableParsingRawHTML &&
					((st.htmlBlock = {
						...
						_(t, e, n) {
							...
							return (
								(n.m = !1),
								{attrs: Q(t[2]), content: _, noInnerParse: s, tag: s ? l : t[1]}
							);
						},
						p: (t, n, r) =>
							V(
